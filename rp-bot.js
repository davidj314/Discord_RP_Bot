...
function get_user_cards(server_id, owner_id, callback, bad){
    var select_query = "SELECT Card_Inv.cid, Names.name, Cards.upval, Cards.leftval, Cards.rightval, Cards.downval  FROM Card_Inv INNER JOIN Names ON Card_Inv.cid=Cards.id INNER JOIN Cards ON Cards.char_id = Names.id WHERE Card_Inv.server_id = $1 AND Card_Inv.owner_id = $2";
